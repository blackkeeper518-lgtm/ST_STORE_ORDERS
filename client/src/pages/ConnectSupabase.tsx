...
export default function ConnectSupabase() {
  ...
  const test = async () => {
    ...
    try {
      ...
      saveSupabaseConfig({ url: cleanUrl, anonKey: cleanKey, orderTable: table.trim() || orderView });
