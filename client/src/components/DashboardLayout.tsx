...
import { getSupabaseConfig, readCanonicalOrders } from "@/lib/canonical";
  ...
  useEffect(() => {
    ...
    const loadNotifications = async () => {
      try {
        ...
        const storageKey = `drakside-last-order-${"ST"}`;
