...
describe("live Supabase order connection", () => {
  it.skipIf(!process.env.SUPABASE_URL || !process.env.SUPABASE_SERVICE_ROLE_KEY)("can read one lightweight row from both live order tables without exposing secrets", async () => {
